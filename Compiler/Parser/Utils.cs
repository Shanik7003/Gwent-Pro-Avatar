...
//             //     var functionSymbol = currentSymbolTable.GetSymbol(methodCall.Funtion.Name);
//             //     if (functionSymbol != null && functionSymbol.IsFunction)
//             //     {
//             //         return "int"; // Asumir que el tipo de retorno es "int" para este ejemplo
//             //     }
//             //     else
//             //     {
//             //         ReportError($"Function '{methodCall.Funtion.Name}' is not declared or not a function");
//             //         return "unknown";
//             //     }
